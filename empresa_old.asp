...
If request("i") = "en" Then
	idioma ="en"
	strSql = "SELECT Top 2 day(Fechadealta) AS Mes, month(Fechadealta) AS Dia, year(Fechadealta) AS Ano, "&_
...
Else
	idioma = "es"
	strSql = "SELECT Top 2 day(Fechadealta) AS Dia, month(Fechadealta) AS Mes, year(Fechadealta) AS Ano, "&_
...
'	 End if %>
     <div class="nota">
	  <div class="copete">
       ...
       <div class="titCopete"><a href="nota.asp?id=<% =idNota %>&amp;i=<% =idioma %>"><% =Left(titNota,90) %></a></div>
 ...
 <div class="derAncho">
  <div class="productos"><img src="img/frase_<% =idioma %>.jpg" width="440" height="205" alt="" title=""  /></div>
