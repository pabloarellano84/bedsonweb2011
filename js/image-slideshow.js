...
************************************************************************************************************/
	...
	var minGalleryXPos;
	var slideSpeed = 0;
	var slideSpeedMultiply;
	var imageGalleryCaptions = new Array();
	function startSlide(e)
	{
		if(document.all)e = event;
		var id = this.id;
		this.getElementsByTagName('IMG')[0].src = 'img/' + this.id + '_over.jpg';
	...
	{
		var id = this.id;
		this.getElementsByTagName('IMG')[0].src = 'img/' + this.id + '.jpg';
		slideSpeed=0;
	}
	...
	function showImage()
	{
		if(activeImage){
			...
			var fondo = activeImage.parentNode.parentNode.parentNode;
			fondo.style.backgroundColor = '#E8E8E9';
			fondo = "";
		}
		this.style.filter = 'alpha(opacity=100)';
		this.style.opacity = 1;
		var fondo = this.parentNode.parentNode.parentNode;
		fondo.style.backgroundColor = '#FAC88A';
		activeImage = this;
		fondo = "";
	}
